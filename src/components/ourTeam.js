    ...
    <OwlCarousel className="owl-theme" loop margin={10} nav>
      <div className="item service-item">
        <div className="author">
          <i>
            <img src="assets/images/hzihgrGK_400x400.jpg" alt="Second Author" />
          </i>
        </div>
        <div className="testimonial-content">
          <h4>Dr. Ahmed  Alhindi</h4>
          <p></p>
      ...
      <div className="item service-item">
        <div className="author">
          <i>
            <img src="assets/images/yousefWA.png" alt="Second Author" />
          </i>
        </div>
        <div className="testimonial-content">
      ...
      <div className="item service-item">
        <div className="author">
          <i>
            <img src="assets/images/tag1337.png" alt="Author Third" />
          </i>
        </div>
        <div className="testimonial-content">
          <h4>Yousef Sarkar</h4>
