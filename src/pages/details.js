    ...
    return (
      <div>
        <div className="container" style={{ marginTop: "150px" }}>
          ...
          {!this.state.isLoadingfavorite_payment &
          !this.state.isLoadingdaily_sales &
          !this.state.isLoadingdaily_orders &
          !this.state.isLoadingDaysHours &
          !this.state.isLoadingrfm &
          !this.state.isLoadingrfmCount &
          !this.state.isLoadingdiscount &
          !this.state.isLoadingdiscountCount &
          !this.state.isLoadingtime &
          !this.state.isLoadingtimeCount &
          !this.state.isLoadingseason &
          !this.state.isLoadingseasonCount &
          !this.state.isLoadingbasket &
          !this.state.isLoadingtopCities ? (
            this.state.basket != null ? (
              <Tabs className="mt-5">
                <TabList>
                  <Tab>Store Level</Tab>

                  <Tab>General RFM Segmentation</Tab>

                  <Tab>Discount Segmentation</Tab>

                  <Tab>Time Segmentation</Tab>

                  <Tab>General Season Segmentation</Tab>
                  ...
                  <div className="row mt-5">
                    <div className="col-lg-8 offset-lg-2">
                      ...
                      <p className="section-subtitle font-secondary text-muted text-center padding-t-30">
                        The data is analyzed to provide useful store-wide
                        results by analyzing orders, purchases and products
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="row mt-5">
                    <div className="col-lg-8 ">
                      ...
                      <p className="section-subtitle font-secondary text-justify text-muted text-left padding-t-30">
                        ...
                        percentage of each payment method among the total
                        payments
                      </p>
                    </div>
                  </div>
                ...
                <TabPanel>
                  <div className="row">
                    <div className="col-lg-8 offset-lg-2">
                      ...
                      <p className="section-subtitle font-secondary text-muted text-center padding-t-30">
                        ...
                        several classifications through the data provided
                        through the file
                      </p>
                    </div>
                  </div>
                  <div className="row mt-5">
                    <div className="col-lg-8 ">
                      <h5 className="section-title text-left">
                      General RFM Segmentation
                      </h5>
                      <p className="section-subtitle font-secondary text-justify text-muted text-left padding-t-30">
                        The customer's rating as good, medium, and excellent
                        based on total payments, inactivity, and the number of
                        purchases
                      </p>
                    </div>
                  </div>
                ...
                <TabPanel>
                  <div className="row mt-5">
                    <div className="col-lg-8 ">
                      ...
                      <p className="section-subtitle font-secondary text-justify text-muted text-left padding-t-30">
                        Classification of the customer to a customer interested
                        in discounts or not, based on the number of times he
                        bought with a discount on the basket
                      </p>
                    </div>
                  </div>
                  <Classification
                ...
                <TabPanel>
                  <div className="row mt-5">
                    <div className="col-lg-8 ">
                      <h5 className="section-title text-left">
                      General Season Segmentation                      </h5>
                      <p className="section-subtitle font-secondary text-justify text-muted text-left padding-t-30">
                        The customer's rating as good, medium, and excellent
                        based on total payments, inactivity, and the number of
                        purchases
                ...
                <TabPanel>
                  <div className="row mt-5">
                    ...
                    <div className="col-lg-8 offset-lg-2">
                      ...
                      <div className="section-title-border margin-t-20"></div>
                      <p className="section-subtitle font-secondary text-muted text-center padding-t-30">
                        Market basket analysis is a data mining technique used
                        by retailers to increase sales by better understanding
                        customer purchasing patterns. It involves analyzing
                        large data sets, such as purchase history, to reveal
                        product groupings, as well as products that are likely
                  ...
                  <div className="row mt-5">
                    <div className="col-lg-12">
                      ...
                      <Classification
                        ...
                        headJson={["antecedents", "consequents" ,"confidence"]}
                        headTable={["Basket Product", "Suggested product","confidence"]}
                        countLabel="Basket"
                      />
                    </div>
                  </div>
